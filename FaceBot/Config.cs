...
namespace FaceBot
{
    ...
    public class Config
    {
        ...
        public static readonly double FacesDetectorInterval = Configuraciones.Default.FacesDetectorInterval;
        public static readonly double FacesRecognizerInterval = Configuraciones.Default.FacesRecognizerInterval;
